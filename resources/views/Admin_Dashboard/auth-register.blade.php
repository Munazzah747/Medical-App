...
<body>
                ...
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form method="POST" action="{{route('register')}}" class="w-100 mt-4 pt-2">
                            ...
                            <!-- <div class="mb-4">
                                <input type="tel" class="form-control" name="user_name" placeholder="Username" required>
                            </div> -->
                            <div class="mb-4 generate-pass">
                                <div class="input-group field">
                                    <input type="password" class="form-control password" id="newPassword" name="password" placeholder="Password Confirm">
    ...
    <script src="{{asset('Admin/assets/vendors/js/lslstrength.min.js')}}"></script>
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
